<div class="screening" style="background-color:darkgray; text-align:center; margin:35px; vertical-align:middle">
  ...
  <div id="consent">
    ...
    <button style="float:center; margin:35px; vertical-align:middle" id="submitButton" class="loadMain" onclick="validateConsent()" type="button">
      <script>
        consent
      </script>
    </button>
  ...
  <div>
    ...
    <div id="load" style="display: none">
      ...
      <button id="nextButton" class="noCursor" onclick="startExperiment()">
        <script>
          load
        </script>
      </button>
